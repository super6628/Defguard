...
///
/// The issuer is resolved through OIDC discovery and a standard refresh-token grant. This works
/// with Microsoft identity platform and Google when the stored refresh token was originally issued
/// with the provider's SMTP/mail scope. Provider-specific authorization/consent remains outside this
/// function; no access or refresh token is logged.
