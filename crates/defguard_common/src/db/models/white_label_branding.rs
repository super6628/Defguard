        ...
        E: PgExecutor<'e>,
    {
        Ok(query_as::<_, Self>(
            "SELECT company_name, product_name, short_name, copyright_name, support_email, \
             support_url, documentation_url, logo_url, nav_logo_url, logo_dark_url, login_image_url, \
             favicon_url, primary_color, login_title, login_subtitle, setup_title, setup_subtitle, \
        ...
        E: PgExecutor<'e>,
    {
        sqlx::query(
            "INSERT INTO white_label_branding (id, company_name, product_name, short_name, \
             ...
             logo_dark_url, login_image_url, favicon_url, primary_color, login_title, login_subtitle, \
             setup_title, setup_subtitle, setup_button_text, updated_at) \
             ...
             logo_dark_url=EXCLUDED.logo_dark_url, login_image_url=EXCLUDED.login_image_url, \
             favicon_url=EXCLUDED.favicon_url, primary_color=EXCLUDED.primary_color, \
             login_title=EXCLUDED.login_title, login_subtitle=EXCLUDED.login_subtitle, \
             setup_title=EXCLUDED.setup_title, setup_subtitle=EXCLUDED.setup_subtitle, \
             setup_button_text=EXCLUDED.setup_button_text, updated_at=NOW()",
        )
