...
pub enum EventType {
    ...
    SmetricAclPolicyCreated,
    SmetricAclPolicyDeleted,
    SmetricAclPolicyStateChanged,
    SmetricAclRuleCreated,
    SmetricAclRuleUpdated,
    SmetricAclRuleDeleted,
    SmetricAclAssignmentChanged,
    SmetricAclPolicyPublished,
    SmetricAclDeploymentQueued,
    SmetricAclDeploymentApplied,
    SmetricAclDeploymentFailed,
    SmetricAclDeploymentAckRejected,
    // S-Metric client traffic policy security events
    SmetricTrafficPolicyCreated,
    SmetricTrafficPolicyUpdated,
    SmetricTrafficPolicyDeleted,
    SmetricTrafficPolicyStateChanged,
    SmetricTrafficPolicyPublished,
    // LDAP sync events
    LdapSyncUserCreated,
    LdapSyncUserDeleted,
